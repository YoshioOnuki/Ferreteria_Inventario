...
public class Proveedor extends javax.swing.JPanel {
    ...
    public static int id_proveedor, tipo_vista;
    ...
    void editar(){
        ...
        if(fila == -1){
            ...
            id_proveedor = Integer.parseInt(tablaProveedor.getValueAt(fila, 0).toString());
    ...
    void vista(int tipo){
        ...
        Vista.ProveedorNuevo ProveedorNuevo = new ProveedorNuevo();
        ProveedorNuevo.setSize(970, 620);
        ProveedorNuevo.setLocation(0, 0);
        Principal.PanelPrincipal.removeAll();
        Principal.PanelPrincipal.add(ProveedorNuevo, BorderLayout.CENTER);
