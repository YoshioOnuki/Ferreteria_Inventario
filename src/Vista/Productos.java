...
public class Productos extends javax.swing.JPanel {
    ...
    public static int id_producto, tipo_vista;
    ...
    void editar(){
        ...
        if(fila == -1){
            ...
            id_producto = Integer.parseInt(tablaProductos.getValueAt(fila, 0).toString());
    ...
    void vista(int tipo){
        ...
        Vista.ProductosNuevo ProductosNuevo = new ProductosNuevo();
        ProductosNuevo.setSize(970, 620);
        ProductosNuevo.setLocation(0, 0);
        Principal.PanelPrincipal.removeAll();
        Principal.PanelPrincipal.add(ProductosNuevo, BorderLayout.CENTER);
