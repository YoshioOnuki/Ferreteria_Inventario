...
public class Clientes extends javax.swing.JPanel {
    ...
    public static int id_cliente, tipo_vista;
    ...
    void editar(){
        ...
        if(fila == -1){
            ...
            id_cliente = Integer.parseInt(tablaClientes.getValueAt(fila, 0).toString());
            tipo_vista = 2;//Vista de editar
        
            Vista.ClienteNuevo ClienteNuevo = new ClienteNuevo();
            ClienteNuevo.setSize(970, 620);
